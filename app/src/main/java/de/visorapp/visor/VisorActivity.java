...
public class VisorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View visorViewTouchArea = findViewById(R.id.camera_preview_touch_area);
        visorViewTouchArea.setOnClickListener(autoFocusClickHandler);/**/
        visorViewTouchArea.setOnLongClickListener(tapAndHoldListener);
